...
/* Operation wrapper: */
struct __ns1__GetGeoIP
{
public:
	_ns1__GetGeoIP *ns1__GetGeoIP;	/* optional element of type ns1:GetGeoIP */
public:
	int soap_type() const { return 20; } /* = unique id SOAP_TYPE___ns1__GetGeoIP */
};
#endif
...
/* Operation wrapper: */
struct __ns1__GetGeoIPContext
{
public:
	_ns1__GetGeoIPContext *ns1__GetGeoIPContext;	/* optional element of type ns1:GetGeoIPContext */
public:
	int soap_type() const { return 24; } /* = unique id SOAP_TYPE___ns1__GetGeoIPContext */
};
#endif
...
/* Operation wrapper: */
struct __ns1__GetGeoIP_
{
public:
	_ns1__GetGeoIP *ns1__GetGeoIP;	/* optional element of type ns1:GetGeoIP */
public:
	int soap_type() const { return 26; } /* = unique id SOAP_TYPE___ns1__GetGeoIP_ */
};
#endif
...
/* Operation wrapper: */
struct __ns1__GetGeoIPContext_
{
public:
	_ns1__GetGeoIPContext *ns1__GetGeoIPContext;	/* optional element of type ns1:GetGeoIPContext */
public:
	int soap_type() const { return 28; } /* = unique id SOAP_TYPE___ns1__GetGeoIPContext_ */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 __ns1__GetGeoIP(struct soap*, _ns1__GetGeoIP *ns1__GetGeoIP, _ns1__GetGeoIPResponse *ns1__GetGeoIPResponse);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__GetGeoIPContext(struct soap*, _ns1__GetGeoIPContext *ns1__GetGeoIPContext, _ns1__GetGeoIPContextResponse *ns1__GetGeoIPContextResponse);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__GetGeoIP_(struct soap*, _ns1__GetGeoIP *ns1__GetGeoIP, _ns1__GetGeoIPResponse *ns1__GetGeoIPResponse);

SOAP_FMAC5 int SOAP_FMAC6 __ns1__GetGeoIPContext_(struct soap*, _ns1__GetGeoIPContext *ns1__GetGeoIPContext, _ns1__GetGeoIPContextResponse *ns1__GetGeoIPContextResponse);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns1__GetGeoIP(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns1__GetGeoIPContext(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns1__GetGeoIP_(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns1__GetGeoIPContext_(struct soap*);
