...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.14 2013-02-28 12:53:44 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns1__GeoIP:
		...
		break;
	case SOAP_TYPE___ns1__GetGeoIPContext_:
		soap_serialize___ns1__GetGeoIPContext_(soap, (const struct __ns1__GetGeoIPContext_ *)ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIP_:
		soap_serialize___ns1__GetGeoIP_(soap, (const struct __ns1__GetGeoIP_ *)ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIPContext:
		soap_serialize___ns1__GetGeoIPContext(soap, (const struct __ns1__GetGeoIPContext *)ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIP:
		soap_serialize___ns1__GetGeoIP(soap, (const struct __ns1__GetGeoIP *)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__GetGeoIPContextResponse:
...
{	(void)type;
	...
	case SOAP_TYPE___ns1__GetGeoIP:
		return (void*)soap_instantiate___ns1__GetGeoIP(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__GetGeoIPContext:
		return (void*)soap_instantiate___ns1__GetGeoIPContext(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__GetGeoIP_:
		return (void*)soap_instantiate___ns1__GetGeoIP_(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__GetGeoIPContext_:
		return (void*)soap_instantiate___ns1__GetGeoIPContext_(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE___ns1__GetGeoIP:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__GetGeoIP*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__GetGeoIP*)p->ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIPContext:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__GetGeoIPContext*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__GetGeoIPContext*)p->ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIP_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__GetGeoIP_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__GetGeoIP_*)p->ptr);
		break;
	case SOAP_TYPE___ns1__GetGeoIPContext_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__GetGeoIPContext_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__GetGeoIPContext_*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC1 _ns1__GetGeoIPContextResponse * SOAP_FMAC2 soap_instantiate__ns1__GetGeoIPContextResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__GetGeoIPContextResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__GetGeoIPContext * SOAP_FMAC2 soap_instantiate__ns1__GetGeoIPContext(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__GetGeoIPContext, n);
		if (size)
...
SOAP_FMAC1 _ns1__GetGeoIPResponse * SOAP_FMAC2 soap_instantiate__ns1__GetGeoIPResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__GetGeoIPResponse, n);
		if (size)
...
SOAP_FMAC1 _ns1__GetGeoIP * SOAP_FMAC2 soap_instantiate__ns1__GetGeoIP(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__GetGeoIP, n);
		if (size)
...
SOAP_FMAC1 ns1__GeoIP * SOAP_FMAC2 soap_instantiate_ns1__GeoIP(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(ns1__GeoIP, n);
		if (size)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__GetGeoIPContext_(struct soap *soap, struct __ns1__GetGeoIPContext_ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__GetGeoIPContext = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__GetGeoIPContext_(struct soap *soap, const struct __ns1__GetGeoIPContext_ *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__GetGeoIPContext_(struct soap *soap, const char *tag, int id, const struct __ns1__GetGeoIPContext_ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
...
SOAP_FMAC3 struct __ns1__GetGeoIPContext_ * SOAP_FMAC4 soap_in___ns1__GetGeoIPContext_(struct soap *soap, const char *tag, struct __ns1__GetGeoIPContext_ *a, const char *type)
{
	size_t soap_flag_ns1__GetGeoIPContext = 1;
	short soap_flag;
	a = (struct __ns1__GetGeoIPContext_ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__GetGeoIPContext_, sizeof(struct __ns1__GetGeoIPContext_), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__GetGeoIPContext_(soap, a);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__GetGeoIPContext_(struct soap *soap, const struct __ns1__GetGeoIPContext_ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__GetGeoIPContext_(soap, tag?tag:"-ns1:GetGeoIPContext", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__GetGeoIPContext_ * SOAP_FMAC4 soap_get___ns1__GetGeoIPContext_(struct soap *soap, struct __ns1__GetGeoIPContext_ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__GetGeoIPContext_(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__GetGeoIPContext_ * SOAP_FMAC2 soap_instantiate___ns1__GetGeoIPContext_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__GetGeoIPContext_(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__GetGeoIPContext_, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetGeoIPContext_);
		if (size)
			*size = sizeof(struct __ns1__GetGeoIPContext_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__GetGeoIPContext_, n);
		if (size)
			*size = n * sizeof(struct __ns1__GetGeoIPContext_);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__GetGeoIPContext_*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__GetGeoIPContext_(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__GetGeoIPContext_ %p -> %p\n", q, p));
	*(struct __ns1__GetGeoIPContext_*)p = *(struct __ns1__GetGeoIPContext_*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__GetGeoIP_(struct soap *soap, struct __ns1__GetGeoIP_ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__GetGeoIP = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__GetGeoIP_(struct soap *soap, const struct __ns1__GetGeoIP_ *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__GetGeoIP_(struct soap *soap, const char *tag, int id, const struct __ns1__GetGeoIP_ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
...
SOAP_FMAC3 struct __ns1__GetGeoIP_ * SOAP_FMAC4 soap_in___ns1__GetGeoIP_(struct soap *soap, const char *tag, struct __ns1__GetGeoIP_ *a, const char *type)
{
	size_t soap_flag_ns1__GetGeoIP = 1;
	short soap_flag;
	a = (struct __ns1__GetGeoIP_ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__GetGeoIP_, sizeof(struct __ns1__GetGeoIP_), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__GetGeoIP_(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__GetGeoIP_(struct soap *soap, const struct __ns1__GetGeoIP_ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__GetGeoIP_(soap, tag?tag:"-ns1:GetGeoIP", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__GetGeoIP_ * SOAP_FMAC4 soap_get___ns1__GetGeoIP_(struct soap *soap, struct __ns1__GetGeoIP_ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__GetGeoIP_(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__GetGeoIP_ * SOAP_FMAC2 soap_instantiate___ns1__GetGeoIP_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__GetGeoIP_(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__GetGeoIP_, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetGeoIP_);
		if (size)
			*size = sizeof(struct __ns1__GetGeoIP_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__GetGeoIP_, n);
		if (size)
			*size = n * sizeof(struct __ns1__GetGeoIP_);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__GetGeoIP_*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__GetGeoIP_(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__GetGeoIP_ %p -> %p\n", q, p));
	*(struct __ns1__GetGeoIP_*)p = *(struct __ns1__GetGeoIP_*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__GetGeoIPContext(struct soap *soap, struct __ns1__GetGeoIPContext *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__GetGeoIPContext = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__GetGeoIPContext(struct soap *soap, const struct __ns1__GetGeoIPContext *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_ns1__GetGeoIPContext(soap, &a->ns1__GetGeoIPContext);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__GetGeoIPContext(struct soap *soap, const char *tag, int id, const struct __ns1__GetGeoIPContext *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_ns1__GetGeoIPContext(soap, "ns1:GetGeoIPContext", -1, &a->ns1__GetGeoIPContext, ""))
		return soap->error;
...
SOAP_FMAC3 struct __ns1__GetGeoIPContext * SOAP_FMAC4 soap_in___ns1__GetGeoIPContext(struct soap *soap, const char *tag, struct __ns1__GetGeoIPContext *a, const char *type)
{
	size_t soap_flag_ns1__GetGeoIPContext = 1;
	short soap_flag;
	a = (struct __ns1__GetGeoIPContext *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__GetGeoIPContext, sizeof(struct __ns1__GetGeoIPContext), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__GetGeoIPContext(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__GetGeoIPContext && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__GetGeoIPContext(soap, "ns1:GetGeoIPContext", &a->ns1__GetGeoIPContext, ""))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__GetGeoIPContext(struct soap *soap, const struct __ns1__GetGeoIPContext *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__GetGeoIPContext(soap, tag?tag:"-ns1:GetGeoIPContext", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__GetGeoIPContext * SOAP_FMAC4 soap_get___ns1__GetGeoIPContext(struct soap *soap, struct __ns1__GetGeoIPContext *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__GetGeoIPContext(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__GetGeoIPContext * SOAP_FMAC2 soap_instantiate___ns1__GetGeoIPContext(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__GetGeoIPContext(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__GetGeoIPContext, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetGeoIPContext);
		if (size)
			*size = sizeof(struct __ns1__GetGeoIPContext);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__GetGeoIPContext, n);
		if (size)
			*size = n * sizeof(struct __ns1__GetGeoIPContext);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__GetGeoIPContext*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__GetGeoIPContext(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__GetGeoIPContext %p -> %p\n", q, p));
	*(struct __ns1__GetGeoIPContext*)p = *(struct __ns1__GetGeoIPContext*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__GetGeoIP(struct soap *soap, struct __ns1__GetGeoIP *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__GetGeoIP = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__GetGeoIP(struct soap *soap, const struct __ns1__GetGeoIP *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_ns1__GetGeoIP(soap, &a->ns1__GetGeoIP);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__GetGeoIP(struct soap *soap, const char *tag, int id, const struct __ns1__GetGeoIP *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_ns1__GetGeoIP(soap, "ns1:GetGeoIP", -1, &a->ns1__GetGeoIP, ""))
		return soap->error;
...
SOAP_FMAC3 struct __ns1__GetGeoIP * SOAP_FMAC4 soap_in___ns1__GetGeoIP(struct soap *soap, const char *tag, struct __ns1__GetGeoIP *a, const char *type)
{
	size_t soap_flag_ns1__GetGeoIP = 1;
	short soap_flag;
	a = (struct __ns1__GetGeoIP *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__GetGeoIP, sizeof(struct __ns1__GetGeoIP), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__GetGeoIP(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__GetGeoIP && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__GetGeoIP(soap, "ns1:GetGeoIP", &a->ns1__GetGeoIP, ""))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__GetGeoIP(struct soap *soap, const struct __ns1__GetGeoIP *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__GetGeoIP(soap, tag?tag:"-ns1:GetGeoIP", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__GetGeoIP * SOAP_FMAC4 soap_get___ns1__GetGeoIP(struct soap *soap, struct __ns1__GetGeoIP *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__GetGeoIP(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__GetGeoIP * SOAP_FMAC2 soap_instantiate___ns1__GetGeoIP(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__GetGeoIP(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__GetGeoIP, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetGeoIP);
		if (size)
			*size = sizeof(struct __ns1__GetGeoIP);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__GetGeoIP, n);
		if (size)
			*size = n * sizeof(struct __ns1__GetGeoIP);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__GetGeoIP*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__GetGeoIP(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__GetGeoIP %p -> %p\n", q, p));
	*(struct __ns1__GetGeoIP*)p = *(struct __ns1__GetGeoIP*)q;
}
